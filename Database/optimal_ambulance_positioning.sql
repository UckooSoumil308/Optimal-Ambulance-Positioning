...
--
-- Database: `optimal_ambulance_positioning`
--
CREATE DATABASE IF NOT EXISTS `optimal_ambulance_positioning` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `optimal_ambulance_positioning`;
...
('q2y983aww6bmtjqozt81snxqw1p7padj', 'eyJ1c2VyaWQiOjJ9:1r922D:Rlh8VlY4pJjlKWH5GQh63y4Z-zesILLdURdCX7Km1kM', '2023-12-15 11:50:17.181384'),
...
('ux75xqsjkmwr6v0uobkfypfi4i0p9894', 'eyJ1c2VyaWQiOjF9:1r90uD:QSYYgtPVYQeEArm2D-mgQxI-DKT_SL8FXF7L62x0vqI', '2023-12-15 10:37:57.715794'),
...
--
-- Table structure for table `remote_user_ambulance_positioning_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_ambulance_positioning_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `Temp` varchar(300) NOT NULL,
  `Wind` varchar(300) NOT NULL,
  `Date_Time` varchar(300) NOT NULL,
  `Age_band_of_driver` varchar(300) NOT NULL,
  `Sex_of_driver` varchar(300) NOT NULL,
  `Vehicle_driver_relation` varchar(300) NOT NULL,
  `Driving_experience` varchar(300) NOT NULL,
  `Type_of_vehicle` varchar(300) NOT NULL,
  `Area_accident_occured` varchar(300) NOT NULL,
  `Types_of_Junction` varchar(300) NOT NULL,
  `Type_of_collision` varchar(300) NOT NULL,
  `Number_of_vehicles_involved` varchar(300) NOT NULL,
  `Number_of_casualties` varchar(300) NOT NULL,
  `Vehicle_movement` varchar(300) NOT NULL,
  `Cause_of_accident` varchar(300) NOT NULL,
  `Accident_severity` varchar(300) NOT NULL,
  `Ambulace_Allocated` varchar(300) NOT NULL,
  `Ambulace_Pickedup` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_ambulance_positioning_prediction`
--

INSERT INTO `remote_user_ambulance_positioning_prediction` (`id`, `Fid`, `Temp`, `Wind`, `Date_Time`, `Age_band_of_driver`, `Sex_of_driver`, `Vehicle_driver_relation`, `Driving_experience`, `Type_of_vehicle`, `Area_accident_occured`, `Types_of_Junction`, `Type_of_collision`, `Number_of_vehicles_involved`, `Number_of_casualties`, `Vehicle_movement`, `Cause_of_accident`, `Accident_severity`, `Ambulace_Allocated`, `Ambulace_Pickedup`, `Latitude`, `Longitude`, `Prediction`) VALUES
(1, '8.41.222.241-10.42.0.42-443-40725-6', '26', '5.1', '01-11-22 9:24', '30', 'Male', 'Owner', '1-2yr', 'Lorry (41?100Q)', 'Residential areas', 'Y Shape', 'Vehicle with vehicle collision', '2', '1', 'Other', 'No distancing', 'Slight Injury', 'Yes', 'Yes', '41.26041515', '-73.42846392', 'In Position'),
(2, '216.58.217.99-10.42.0.42-443-32806-6', '27', '5.3', '01-11-22 9:39', '40', 'Male', 'Employee', '1-2yr', 'Lorry (41?100Q)', 'Other', 'No junction', 'Vehicle with vehicle collision', '2', '1', 'Going straight', 'Getting off the vehicle improperly', 'Slight Injury', 'No', 'No', '41.0737512', '-73.51692887', 'Not In Position'),
(3, '10.42.0.42-106.11.92.6-37871-443-6', '32', '5.6', '01-11-22 10:01', '60', 'Male', 'Employee', '2-5yr', 'Automobile', ' Industrial areas', 'No junction', 'Vehicle with vehicle collision', '2', '1', 'U-Turn', 'No priority to vehicle', 'Slight Injury', 'No', 'No', '41.20019065', '-73.25350969', 'Not In Position'),
(4, '10.42.0.211-10.42.0.1-51731-53-17', '33', '2.7', '01-11-22 14:37', '35', 'Male', 'Employee', '2-5yr', 'Public (12 seats)', ' Church areas', 'Y Shape', 'Vehicle with vehicle collision', '2', '1', 'Going straight', 'Overturning', 'Slight Injury', 'Yes', 'Yes', '41.78214303', '-72.52482423', 'In Position');
...
(1, 'Gopal', 'Gopal123@gmail.com', 'Gopal', '9535866270', 'India', 'Karnataka', 'Bangalore'),
...
(7, 'Deep Neural Network (DNN)', '47.0479704797048'),
(8, 'SVM', '50.184501845018445'),
(9, 'KNeighborsClassifier', '45.38745387453875');
